                    ...
                    <table id="projects_report_table" data-toggle="table"
                        ...
                        <thead>
                            <tr>
                                ...
                                <th rowspan="2" data-field="title" data-sortable="true">
                                ...
                                <th rowspan="2" data-field="priority" data-sortable="true">
                                    {{ get_label('priority', 'Priority') }}</th>
                                <th rowspan="2" data-field="budget.total" data-sortable="true">
                                    {{ get_label('budget', 'Budget') }}</th>
                                <th colspan="3">{{ get_label('time', 'Time') }}</th>
                                <th colspan="4">{{ get_label('tasks', 'Tasks') }}</th>
                                <th colspan="2">{{ get_label('team', 'Team') }}</th>
                                <th rowspan="2" data-field="clients" data-formatter="ClientFormatter">
                                    {{ get_label('clients', 'Clients') }}</th>
                            </tr>
                            <tr>
                                <th data-field="start_date" data-sortable="true">
                                    {{ get_label('start_date', 'Start Date') }}</th>
                                <th data-field="end_date" data-sortable="true">{{ get_label('end_date', 'End Date') }}
                                </th>
                                <th data-field="time.total_days" data-sortable="true">
                                    {{ get_label('total_days', 'Total Days') }}</th>
                                <th data-field="time.days_elapsed" data-sortable="true">
                                    {{ get_label('days_elapsed', 'Days Elapsed') }}</th>
                                <th data-field="time.days_remaining" data-sortable="true">
                                    {{ get_label('days_remaining', 'Days Remaining') }}</th>
                                <th data-field="tasks.total" data-sortable="true">{{ get_label('total_tasks', 'Total') }}
                                </th>
                                <th data-field="tasks.due" data-sortable="true">{{ get_label('due_tasks', 'Due Tasks') }}</th>
                                <th data-field="tasks.overdue" data-sortable="true">
                                    {{ get_label('overdue_tasks', 'Overdue Tasks') }}</th>
                                <th data-field="tasks.overdue_days" data-sortable="true">
                                    {{ get_label('overdue_days', 'Overdue Days') }}</th>
                                <th data-field="team.total_members" data-sortable="true">
                                    {{ get_label('team_members', 'Team Members') }}</th>
