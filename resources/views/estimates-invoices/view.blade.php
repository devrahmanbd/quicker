...
@section('content')
    <div class="container-fluid">
        <div class="d-flex justify-content-between mt-4" id="section-not-to-print">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-style1">
                        ...
                        <li class="breadcrumb-item active">
                            <a
                                href="{{ route('estimates-invoices.index') }}"><?= get_label('etimates_invoices', 'Estimates/Invoices') ?></a>
                        </li>
                        <li class="breadcrumb-item active">
                            <?= $estimate_invoice->type == 'estimate' ? get_label('view_estimate', 'View estimate') : get_label('view_invoice', 'View invoice') ?>
                        </li>
            ...
            <div>
                <a href="{{ route('estimates-invoices.index') }}"><button type="button" class="btn btn-sm btn-primary"
            ...
            <div class="card-body">
                <div id='section-to-print'>
                    ...
                    <div class="row mt-4">
                        <div class="col-md-6">
                            <ul class="list-group list-group-flush">
                                ...
                                <li class="list-group-item">
                                    ...
                                    {{ $estimate_invoice->city }}, {{ $estimate_invoice->state }},
                                    {{ $estimate_invoice->country }}, {{ $estimate_invoice->zip_code }}<br>
                        ...
                        <div class="col-md-6">
                            <ul class="list-group list-group-flush">
                                ...
                                <li class="list-group-item">
                                    <strong><?= $estimate_invoice->type == 'estimate' ? get_label('estimate_no', 'Estimate No.') : get_label('invoice_no', 'Invoice No.') ?>:</strong>
                                    #{{ $estimate_invoice->type == 'estimate' ? get_label('estimate_id_prefix', 'ESTMT-') : get_label('invoice_id_prefix', 'INVC-') }}
                                    {{ $estimate_invoice->id }}<br>
                                    <strong><?= get_label('from_date', 'From date') ?>:</strong>
                                    {{ $estimate_invoice->from_date }}<br>
                                    <strong><?= get_label('to_date', 'To date') ?>:</strong>
                                    {{ $estimate_invoice->to_date }}<br>
                    ...
                    <div class="row mt-4 mx-1">
                        <div class="col-md-12">
                            <h5><?= $estimate_invoice->type == 'estimate' ? get_label('estimate_summary', 'Estimate summary') : get_label('invoice_summary', 'Invoice summary') ?>
                            </h5>
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($estimate_invoice->items as $item)
                                            ...
                                            <tr>
                                                <td>{{ $count }}</td>
                                                <td>{{ $item->title }}</td>
                                                <!-- Assuming 'title' is the attribute containing product/service name -->
                    ...
                    @if ($estimate_invoice->type == 'invoice')
                        <div class="row mt-4 mx-1">
                            <div class="col-md-12">
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($estimate_invoice->payments as $payment)
                                                @php
                                                    ...
                                                    $paid_amount = $estimate_invoice->payments
                                                        ->where('id', '<=', $payment->id)
                                                        ->sum('amount');
                                ...
                                @else
                                    <p><?= get_label('no_payments_found_invoice', 'No payments found for this invoice.') ?>
                                    </p>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="text-end mt-4">
                                ...
                                <div class="invoice-detail-item">
                                    ...
                                    <div class="invoice-detail-value">{{ format_currency($estimate_invoice->tax_amount) }}
                                    </div>
                                </div>
                                <div class="invoice-detail-item">
                                    <div class="invoice-detail-name"><?= get_label('final_total', 'Final total') ?></div>
                                    <div class="invoice-detail-value">{{ format_currency($estimate_invoice->final_total) }}
                                    </div>
                                </div>
                            </div>
                        </div>
