            ...
            <div class="container pb-lg-9 pb-7 pt-7 postion-relative z-index-2">
                <div class="row">
                    <div class="col-md-8 mx-auto text-center">
                        ...
                        <h3 class="text-white">
                            {{ get_label('quicker_features_heading', $general_settings['company_title'] . ' Powerful Features for Efficient Project Management') }}
                        </h3>
                        <p class="text-center text-white fs-0 fs-md-1 mt-3 mb-3">
                            {{ get_label('quicker_features_subheading', 'Streamline your team\'s workflow and boost productivity with our comprehensive set of features.') }}
                        </p>
                    </div>
                </div>
            </div>
                            ...
                            <div class="card-body text-center">
                                ...
                                <div class="row mb-6">
                                    <div class="col-md-6 col-lg-3 text-center">
                                        ...
                                        <p class="text-muted">
                                            {{ get_label('integrations_desc', 'Connect Quicker with your favorite tools and services for a seamless workflow experience.') }}
                                        </p>
                                    </div>
                                    <div class="col-md-6 col-lg-3 text-center">
                                    ...
                                    <div class="col-md-6 col-lg-3 text-center">
                                        ...
                                        <p class="text-muted">
                                            {{ get_label('customization_desc', 'Tailor Quicker to your specific needs with our flexible customization options and integrations.') }}
                                        </p>
                                    </div>
                                </div>
                                <div class="row mb-6">
