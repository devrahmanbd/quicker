...
@section('content')
                    ...
                    <div class="col-lg-10">
                        ...
                        <div class="mb-3 mt-2">
                            ...
                            <div class="row">
                                ...
                                {!! create_label(
                                    'integrations_desc',
                                    'Connect Quicker with your favorite tools and services for a seamless workflow experience.',
                                    Session::get('locale'),
                                ) !!}
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                ...
                                {!! create_label(
                                    'customization_desc',
                                    'Tailor Quicker to your specific needs with our flexible customization options and integrations.',
                                    Session::get('locale'),
                                ) !!}
                            </div>
                            <div class="row">
 ...
 {!! create_label('team_member_on_leave_alert_whatsapp_info', 'This template will be used for the WhatsApp notification sent to team members upon approval of a leave request, informing them about the absence of the requestee.',Session::get('locale')) !!}
                        ...
                        {!! create_label('clear_cache', 'Clear Cache' , Session::get('locale')) !!}
