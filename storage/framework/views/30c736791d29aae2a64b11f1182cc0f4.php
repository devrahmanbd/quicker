            ...
            <div class="misc-wrapper">
                ...
                <?php if(Request::is('*favorite*')): ?>
                    <a class="btn btn-primary"
                        href="<?php echo e(route('projects.index')); ?>"><?php echo e(get_label('projects', 'Projects')); ?></a>
                <?php else: ?>
                    <?php
...
<?php /**PATH C:\Siddharth Gor\Test\resources\views/components/empty-state-card.blade.php ENDPATH**/ ?>