                                ...
                                <li class="mb-2">
                                    ...
                                    <ul class="list-unstyled text-smallcaps m-3 my-2 ps-0">
                                        <?php
                                            ...
                                            $checkedModules = [];
                                            $uncheckedModules = [];
                                            foreach (config('quicker.modules') as $moduleName => $moduleData) {
                                                $included = in_array($moduleName, $modules);
                                                if ($included) {
                                                    $checkedModules[] = [
                                                        'name' => $moduleName,
...
<?php echo $__env->make('front-end.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /srv/http/localhost/resources/views/front-end/index.blade.php ENDPATH**/ ?>