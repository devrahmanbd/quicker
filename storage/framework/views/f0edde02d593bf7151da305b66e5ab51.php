            ...
            <div class="row justify-content-center">
                <div class="col-md-12">
                    <div class="alert alert-primary text-center" role="alert">
                        <p class="mb-0 fs-5 text-dark">No active subscription found.</p>
                        <a href="<?php echo e(route('subscription-plan.buy-plan')); ?>"
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Siddharth Gor\Test\resources\views/subscription-plan/index.blade.php ENDPATH**/ ?>